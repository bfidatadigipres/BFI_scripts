...
transcode_path="${QNAP_04}${TRANS}"
dump_to='mp4_transcode_make_jpeg_files_qnap_imagen.txt'
dump_temp='mp4_transcode_make_jpeg_files_qnap_imagen_temp.txt'
...
grep '/mnt/' "${dump_temp}" | parallel --jobs 20 "$PYENV $python_script {}"
