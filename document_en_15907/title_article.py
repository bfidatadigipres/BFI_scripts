...
TITLE_ARTICLES = {'af': ["Die ", "'N ", "DIE ", "'N "],
                  ...
                  'nl': ["De ", "Het ", "'S ", "Een ", "Eene ", "'N ", "DE ", "HET ", "EEN ", "EENE "],
                  'en': ["The ", "A ", "An ", "THE ", "AN "],
                  'fr': ["Le ", "La ", "L'", "Les ", "Un ", "Une ", "LE ", "LA ", "LES ", "UN ", "UNE "],
                  'de': ["Der ", "Die ", "Das ", "Ein ", "Eine ", "DER ", "DIE ", "DAS ", "EIN ", "EINE "],
                  'el': ["Ho ", "He ", "To ", "Hoi ", "Hai ", "Ta ", "Henas ", "Heis ", "Mia ", "Hena ", "HO ", "HE ", "TO ", "HOI ", "HAI ", "TA ", "HENAS ", "HEIS ", "MIA ", "HENA "],
                  'he': ["Ha-" , "Ho-", "HA-", "HO-"],
                  'hu': ["A ", "Az ", "Egy ", "AZ ", "EGY "],
                  'is': ["Hinn ", "Hin ", "Hid ", "Hinir ", "Hinar ", "HINN ", "HIN ", "HID ", "HINIR ", "HINAR "],
                  'it': ["Il ", "La ", "Lo ", "I ", "Gli ", "Gl'", "Le ", "L'", "Un ", "Uno ", "Una ", "Un'", "IL ", "LA ", "LO ", "GLI ", "GL'", "LE ", "UN ", "UNO ", "UNA ", "UN'"],
                  'nb': ["Den ", "Det ", "De ", "En ", "Et ", "DEN ", "DET ", "DE ", "EN ", "ET "],
                  'nn': ["Dent ", "Det ", "Dei ", "Ein ", "Ei ", "Eit ", "DENT ", "DET ", "DEI ", "EIN ", "EI ", "EIT "],
                  ...
                  'tr': ["Bir ", "BIR "],
                  'cy': ["Y ", "Yr ", "YR "],
                  'yi': ["Der ", "Di ", "Die ", "Dos ", "Das ", "A ", "An ", "Eyn ", "Eyne ", "DER ", "DI ", "DIE ", "DOS ", "DAS ", "AN ", "EYN ", "EYNE "]
}
    ...
    if count == 1:
        if 'ar' in language or 'he' in language:
            ...
            if title_supplied.startswith(("El-", "Ad-", "Ag-", "Ak-", "An-", "Ar-", "As-", "At-", "Az-", "Ha-", "Ho-" \
                                          "EL-", "AD-", "AG-", "AK-", "AN-", "AR-", "AS-", "AT-", "AZ-", "HA-", "HO-")):
