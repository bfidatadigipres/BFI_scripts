...
TEXT_PATH = os.path.join(
    os.environ["CODE_BFI"], "document_en_15907/stora2_dump_text.txt"
)
        ...
        for line in paths:
            ...
            if any(dt in line for dt in date_range):
                ...
                if "stream.mpeg2.ts" in files:
                    ...
                    print(
                        f"DELETING folder contents - Stream.mpeg2.ts NOT found: {line}"
                    )
                    ...
                    for file in files:
                        ...
                        try:
                            ...
                            logger.warning(
                                "Unable to delete directory content: %s\n %s",
                                fpath,
                                error,
                            )
                            continue
