...
PRORES_POLICY: Final = os.path.join(PATH_POLICY, 'BFI_download_transcode_basic_prores.xml')
...
def create_ffmpeg_command(fullpath: str, output: str, video_data: list[Optional[str]]) -> list[str]:
    '''
