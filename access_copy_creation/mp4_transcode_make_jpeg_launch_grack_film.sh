...
transcode_path1="${GRACK_01}${TRANS}"
dump_to="${LOG_PATH}mp4_transcode_make_jpeg_files_grack_film.txt"
...
echo " ========================= SHELL LAUNCH - GRACK FILM ========================== $date_FULL" >> "${log_path}"
...
echo " ========================= SHELL END - GRACK FILM ========================== $date_FULL" >> "${log_path}"
