...
def get_results(filepath, grouping, object_number):
    ...
    if hits >= 1:
        ...
        print(f'* CID query failed to obtain result using (object.object_number->(grouping.lref="grouping")) and (input.name="datadigipres") and (source_item->object_number="object_number")))) for {object_number}')
