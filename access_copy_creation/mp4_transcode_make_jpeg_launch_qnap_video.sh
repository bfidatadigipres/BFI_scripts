...
transcode_path1="${QNAP_01}${TRANS}"
dump_to="${LOG_PATH}mp4_transcode_make_jpeg_qnap_video.txt"
...
echo " ========================= SHELL LAUNCH - QNAP VIDEO ========================== $date_FULL" >> "${log_path}"
...
echo " ========================= SHELL END - QNAP VIDEO ========================== $date_FULL" >> "${log_path}"
