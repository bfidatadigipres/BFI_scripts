...
SUB_CSV = os.path.join(os.environ.get("CODE_DEPENDS"), "workflow/f47/submissions.csv")
SEL_CSV = os.path.join(os.environ.get("CODE_DEPENDS"), "workflow/f47/selections.csv")
ERR_CSV = os.path.join(os.environ.get("CODE_DEPENDS"), "workflow/f47/errors.csv")
CONFIG = os.path.join(os.environ.get("CODE_DEPENDS"), "workflow/f47/config.yaml")
NOW = datetime.now()
