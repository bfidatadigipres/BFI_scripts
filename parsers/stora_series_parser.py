"""
Pydantic models for the PA Media JSON payload (series).
...
class Deeplink(APIModel):
    ...
    @field_validator("href", "url", mode="before")
    @classmethod
...
class Series(APIModel):
    ...
    @classmethod
    def _non_negative_runtime(cls, v: Any) -> Any:
        return _validate_non_negative(v)
...
def parse_payload_strict_json(raw_json: str) -> Optional[Series]:
    """
    Strict parser:
