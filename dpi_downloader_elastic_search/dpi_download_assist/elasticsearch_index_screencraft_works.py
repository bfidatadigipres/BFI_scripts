#!/usr/bin/env python3
"""
Fetch screencraft Work prirefs from CID, retrieve XML, and bulk index into
Elasticsearch (dpi_screencraft_works).
"""
...
def xml_to_document(xml_text: str, priref: str) -> dict:
    return generic_xml_to_document(xml_text, priref, root_tag=ROOT_XML_TAG)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Fetch screencraft Work prirefs from CID, retrieve XML, "
...
def main() -> int:
    args = parse_args()
    logger = setup_logger("screencraft_works_indexer", LOG_PATH)
