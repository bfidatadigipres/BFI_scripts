...
transcode_path1="${QNAP_02}"
dump_to="${LOG_PATH}mp4_transcode_make_jpeg_qnap_h22.txt"
...
echo " ========================= SHELL LAUNCH - QNAP H22 ========================== $date_FULL" >> "${log_path}"
...
grep '/mnt/' "${dump_to}" | parallel --jobs 10 "sudo ${PYENV} $python_script {}"

echo " ========================= SHELL END - QNAP H22 ========================== $date_FULL" >> "${log_path}"
