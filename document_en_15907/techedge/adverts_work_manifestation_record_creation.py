...
Initially this script should catch-up
with current ingest, then run daily BAU.
Initial run needs to manage
which "YYYY-MM-DD_BFIExport.csv" is
being worked on - no repeats.
...
CSV_PATH = os.path.join(STORAGE, "adverts_techedge_no_dupes/")
CSV_LIST = os.path.join(STORAGE, "adverts_techedge_no_dupes/processed_csvs.txt")
