...
hdlr = logging.FileHandler(
    os.path.join(os.environ["GRACK_H22"], "/mediaconch/rna_document_move.txt")
)
...
def main(filepath: str, frame_work: str, destination=None) -> None:
    ...
    logger.info(
        "Number of CID records with filename %s already = %s", in_file, hit_count
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--destination",
        type=str,
        help="folder path for renamed files to be moved to",
    )
