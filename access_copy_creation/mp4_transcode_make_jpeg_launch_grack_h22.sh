...
transcode_path1="${GRACK_02}${TRANS}"
dump_to="${LOG_PATH}mp4_transcode_make_jpeg_grack_h22.txt"
...
echo " ========================= SHELL LAUNCH - GRACK H22 ========================== $date_FULL" >> "${log_path}"
...
# Command to build file list to pass to Python script
...
grep '/mnt/' "${dump_to}" | parallel --jobs 16 "sudo ${PYENV} $python_script {}"

echo " ========================= SHELL END - GRACK H22 ========================== $date_FULL" >> "${log_path}"
