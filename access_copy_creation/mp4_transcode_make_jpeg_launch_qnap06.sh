...
transcode_path1="${QNAP_06}${TRANS}"
dump_to="${LOG_PATH}mp4_transcode_make_jpeg_files_qnap06.txt"
...
echo " ========================= SHELL LAUNCH - QNAP06 ========================== $date_FULL" >> "${log_path}"
...
echo " ========================= SHELL END - QNAP06  ========================== $date_FULL" >> "${log_path}"
