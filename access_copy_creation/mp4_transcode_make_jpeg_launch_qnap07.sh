...
transcode_path1="${QNAP_07}${TRANS}"
dump_to="${LOG_PATH}mp4_transcode_make_jpeg_files_qnap07.txt"
...
echo " ========================= SHELL LAUNCH - QNAP07 ========================== $date_FULL" >> "${log_path}"
...
echo " ========================= SHELL END - QNAP07 ========================== $date_FULL" >> "${log_path}"
