...
transcode_path1="${QNAP_08}${TRANS}"
dump_to="${LOG_PATH}mp4_transcode_make_jpeg_files_qnap08.txt"
...
echo " ========================= SHELL LAUNCH - QNAP08 ========================== $date_FULL" >> "${log_path}"
...
echo " ========================= SHELL END - QNAP08 ========================== $date_FULL" >> "${log_path}"
