...
@pytest.mark.parametrize(
    ...
    [
        (
            [
                {"input.name": "user1"},
                {"input.date": "2025-10-27"},
                {"reference_number": "N_1234657_01of07.mov"},
                {"object.object_number": "N-1234657"},
                {"imagen.media.part": "01"},
                {"imagen.media.total": "07"},
            ],
            [
                b"<input.name>datadigipres</input.name>",
                b"<input.date>2025-10-27</input.date>",
                b"<reference_number>N_1234657_01of07.mov</reference_number>",
                b"<object.object_number>N-1234657</object.object_number>",
                b"<imagen.media.part>01</imagen.media.part>",
                b"<imagen.media.total>07</imagen.media.total>",
            ],
        ),
    ],
)
