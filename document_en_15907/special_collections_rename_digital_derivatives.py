...
def build_defaults(work_data: Optional[tuple[str, str, str, str, str, str]], ipath: str, image: str, arg: str, obj=None) -> Optional[tuple[list[dict[str, str]], Optional[str]]]:
    '''
