...
def bp_physical_placement(fname: str, bucket: str) -> bool:
    ...
    query: ds3.GetPhysicalPlacementForObjectsSpectraS3Request = (
        ds3.GetPhysicalPlacementForObjectsSpectraS3Request(bucket, object_list)
    )
    result: ds3.GetPhysicalPlacementForObjectsSpectraS3Response = (
        CLIENT.get_physical_placement_for_objects_spectra_s3(query)
    )
    data = result.result
